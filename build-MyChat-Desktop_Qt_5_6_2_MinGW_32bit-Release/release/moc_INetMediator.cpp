...
#include "../../MyChat/mediator/INetMediator.h"
...
const QMetaObject INetMediator::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_INetMediator.data,
      qt_meta_data_INetMediator,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *INetMediator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_INetMediator.stringdata0))
        return static_cast<void*>(const_cast< INetMediator*>(this));
